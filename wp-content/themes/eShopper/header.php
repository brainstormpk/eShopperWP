...
<html <?php language_attributes(); ?> class="no-js">
    <head>
        ...
        <link href="<?php echo esc_url(get_template_directory_uri()); ?>/css/price-range.css" rel="stylesheet">
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="logo pull-left">
                                <a href="index.html"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/images/home/logo.png" alt="" /></a>
                            </div>
